...
console.log(maxN(24, 45));
console.log(maxN(16, 8));
console.log(maxN(24, 24));
...
console.log(getSize(6));
console.log(getSize(12));
console.log(getSize(18));
console.log(getSize(24));
console.log(getSize("Mario"));
...
console.log(isItEight(6, 5));
console.log(isItEight(8, 5));
console.log(isItEight(4, 4));
console.log(isItEight(32, 24));
console.log(isItEight(12, 20));
...
console.log(shippingDiscount(totalShoppingCart));
...
console.log(shippingBlack(totalShoppingCartBlack));
